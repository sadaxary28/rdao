...
public class HashIterator implements RecordIterator {

    public HashIterator(DBTable table, DBField[] selectingFields, HashFilter filter, DBDataReader dataReader) {
        // TODO realize
    }
