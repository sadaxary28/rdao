 ...
 * Первый бит всегда ноль (индекс: 0) (что бы получалось положительное число)
 * Следующие 8 битов отведены для идентификатора шарда (индекс: с 1 по 8 - включительно)
 * Оставшиеся 55 битов отведены для уникального идинтификатора игрока (индекс: с 9 по 63 - включительно)
 *
