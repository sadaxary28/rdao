...
public class MethodHandlerImpl implements MethodHandler {
    ...
    public MethodHandlerImpl(Class<? extends DomainObject> clazz) {
        ...
        Entity annotationEntity = StructEntity.getEntityAnnotation(clazz);
        this.columnFamily = annotationEntity.name();
    }
...
//            return null;
//        } else
//        if ("remove".equals(thisMethod.getName())) {
//            removeDomainObject(domainObject);
//            return null;
//        } else
//        if (structEntity.isGetterMethod(thisMethod.getName())) {
...
//            byte[] bValue = dataSource.getField(structEntity.annotationEntity.name(), self.getId(), formatFieldName);
